...
import AndroidCreative1 from "../../../../assets/AndroidCreative1.png";
import AndroidCreative2 from "../../../../assets/AndroidCreative2.png";
...
const AndroidData = [
  {
    id: 1,
    creativeImg: AndroidCreative1,
  },
  {
    id: 2,
    creativeImg: AndroidCreative2,
  },
];
const Android = () => {
  const ButtonClick = () => {};
    ...
    <div className=" mr-1 ml-1   ">
      ...
      <div className=" ml-[20px] mr-[20px] md:ml-[50px] md:mr-[50px] lg:ml-[150px] lg:mr-[150px] mb-10 hover:text-blue-500 text-justify">
        <p className=" text-[10px] md:text-[15px] lg:text-[20px] text-gray-500 ">
          ...
          Android app development. Our team of Android developers will deliver
          high-performance, user-centric, and reliable custom Android apps that
